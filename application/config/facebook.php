...
$config['facebook_login_redirect_url']  = 'example/web_login'; //change to where to redirect
$config['facebook_logout_redirect_url'] = 'example/logout'; //change to where to redirect
