	...
	<nav>
		<div class="nav-wrapper">
			...
			<ul class="right hide-on-med-and-down">
				...
				<li>
					<a id="login-register-btn" href="login.php" class="waves-effect waves-light center"><i class="fa fa-user" aria-hidden="true"></i> Login / Register</a>
				</li>
				<!-- <li>
...
<ul id="slide-out" class="side-nav">
	...
	<li>
		<a id="login-register-btn" href="login.php" class="waves-effect waves-light"> Login / Register<i class="fa fa-user-circle-o fa-2x" aria-hidden="true" ></i></a>
	</li>
	<!-- <li>
