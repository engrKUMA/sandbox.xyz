...
if (void 0 === jQuery) {
        ...
        return function(t, e, i, n) {
            ...
            function l(t, i, n, o) {
                ...
                function p(e, i, o) {
                    var a, r, s = 0;
                    do {
                        r = i + (o - i) / 2, a = l(r, t, n) - e, a > 0 ? o = r : i = r
                    } while (Math.abs(a) > m && ++s < y);
                    return r
                }
                ...
                function h(e) {
                    ...
                    var r = i + (e - C[--o]) / (C[o + 1] - C[o]) * w,
                        s = c(r, t, n);
                    return s >= g ? u(e, r) : 0 == s ? r : p(e, i, i + w)
                }
                ...
                if (t) {
                    ...
                    for (var a = 0; i > a; a++)
                        if (b.State.calls[a]) {
                            ...
                            for (var m = Math.min((e - h) / c.duration, 1), y = 0, w = l.length; w > y; y++) {
                                var k = l[y],
                                    T = k.element;
                                if (r(T)) {
                                    var S = !1;
                                    ...
                                    for (var A in k)
                                        if ("element" !== A) {
                                            var O, E = k[A],
                                                M = v.isString(E.easing) ? b.Easings[E.easing] : E.easing;
                                            if (1 === m) O = E.endValue;
                                            else {
                                                var I = E.endValue - E.startValue;
                                                if (O = E.startValue + I * M(m, c, I), !f && O === E.currentValue) continue
                                            }
                                            if (E.currentValue = O, "tween" === A) g = O;
                                            else {
                                                if (x.Hooks.registered[A]) {
                                                    var q = x.Hooks.getRoot(A),
                                                        _ = r(T).rootPropertyValueCache[q];
                                                    _ && (E.rootPropertyValue = _)
                                                }
                                                var V = x.setPropertyValue(T, A, E.currentValue + (0 === parseFloat(O) ? "" : E.unitType), E.rootPropertyValue, E.scrollData);
                                                x.Hooks.registered[A] && (r(T).rootPropertyValueCache[q] = x.Normalizations.registered[q] ? x.Normalizations.registered[q]("extract", null, V[1]) : V[1]), "transform" === V[0] && (S = !0)
                                            }
                                        }
                                    c.mobileHA && r(T).transformCache.translate3d === n && (r(T).transformCache.translate3d = "(0px, 0px, 0px)", S = !0), S && x.flushTransformCache(T)
                                }
                            }
                            c.display !== n && "none" !== c.display && (b.State.calls[a][2].display = !1), c.visibility !== n && "hidden" !== c.visibility && (b.State.calls[a][2].visibility = !1), c.progress && c.progress.call(s[1], s[1], m, Math.max(0, h + c.duration - e), h, g), 1 === m && d(a)
                        }
                }
            ...
            function d(t, e) {
                ...
                for (var i = b.State.calls[t][0], o = b.State.calls[t][1], a = b.State.calls[t][2], s = b.State.calls[t][4], l = !1, c = 0, u = i.length; u > c; c++) {
                    var d = i[c].element;
                    if (e || a.loop || ("none" === a.display && x.setPropertyValue(d, "display", a.display), "hidden" === a.visibility && x.setPropertyValue(d, "visibility", a.visibility)), !0 !== a.loop && (p.queue(d)[1] === n || !/\.velocityQueueEntryFlag/i.test(p.queue(d)[1])) && r(d)) {
                        ...
                        }), a.mobileHA && (h = !0, delete r(d).transformCache.translate3d), h && x.flushTransformCache(d), x.Values.removeClass(d, "velocity-animating")
                    }
                ...
                if (!(7 >= h)) {
                    ...
                    var x = b.CSS = {
                        ...
                        Hooks: {
                            ...
                            registered: {},
                            register: function() {
                                for (a = 0; a < x.Lists.colors.length; a++) {
                                    var t = "color" === x.Lists.colors[a] ? "0 0 0 1" : "255 255 255 1";
                                    x.Hooks.templates[x.Lists.colors[a]] = ["Red Green Blue Alpha", t]
                                }
                                var e, i, n;
                                if (h)
                                    for (e in x.Hooks.templates) {
                                        n = (i = x.Hooks.templates[e])[0].split(" ");
                                        var o = i[1].match(x.RegEx.valueSplit);
                                        "Color" === n[0] && (n.push(n.shift()), o.push(o.shift()), x.Hooks.templates[e] = [n.join(" "), o.join(" ")])
                                    }
                                for (e in x.Hooks.templates) {
                                    n = (i = x.Hooks.templates[e])[0].split(" ");
                                    for (var a in n) {
                            ...
                            injectValue: function(t, e, i) {
                                ...
                                if (n) {
                                    var o, a = n[0],
                                        r = n[1];
                                    return i = x.Hooks.cleanRootPropertyValue(a, i), o = i.toString().match(x.RegEx.valueSplit), o[r] = e, o.join(" ")
                                }
                                return i
                            }
                        },
                        Normalizations: {
                            ...
                            register: function() {
                                ...
                                for (t = 0; t < x.Lists.transformsBase.length; t++) ! function() {
                        ...
                        getPropertyValue: function(t, i, o, a) {
                            ...
                            if (x.Hooks.registered[i]) {
                                ...
                                var d, f;
                                "transform" !== (d = x.Normalizations.registered[i]("name", t)) && (f = s(t, x.Names.prefixCheck(d)[0]), x.Values.isCSSNullValue(f) && x.Hooks.templates[i] && (f = x.Hooks.templates[i][1])), l = x.Normalizations.registered[i]("extract", t, f)
                            }
                            if (!/^[\d-]/.test(l))
                    ...
                    var k = function() {
                            ...
                            function t(t) {
                                function d(t, e) {
                                    var i = n,
                                        o = n,
                                        r = n;
                                    return v.isArray(t) ? (i = t[0], !v.isArray(t[1]) && /^[\d-]/.test(t[1]) || v.isFunction(t[1]) || x.RegEx.isHex.test(t[1]) ? r = t[1] : (v.isString(t[1]) && !x.RegEx.isHex.test(t[1]) || v.isArray(t[1])) && (o = e ? t[1] : c(t[1], s.duration), t[2] !== n && (r = t[2]))) : i = t, e || (o = o || s.easing), v.isFunction(i) && (i = i.call(a, T, C)), v.isFunction(r) && (r = r.call(a, T, C)), [i || 0, o, r]
                                }
                                ...
                                if ("scroll" === A) {
                                    var m, w, k, S = /^x$/i.test(s.axis) ? "Left" : "Top",
                                        O = parseFloat(s.offset) || 0;
                                    s.container ? v.isWrapped(s.container) || v.isNode(s.container) ? (s.container = s.container[0] || s.container, m = s.container["scroll" + S], k = m + p(a).position()[S.toLowerCase()] + O) : s.container = null : (m = b.State.scrollAnchor[b.State["scrollProperty" + S]], w = b.State.scrollAnchor[b.State["scrollProperty" + ("Left" === S ? "Top" : "Left")]], k = p(a).offset()[S.toLowerCase()] + O), l = {
                                        scroll: {
                                            rootPropertyValue: !1,
                                            startValue: m,
                                            currentValue: m,
                                    ...
                                    I = p.extend(!0, {}, r(a).tweensContainer);
                                    for (var E in I)
                                        if ("element" !== E) {
                                            var M = I[E].startValue;
                                            I[E].startValue = I[E].currentValue = I[E].endValue, I[E].endValue = M, v.isEmptyObject(y) || (I[E].easing = s.easing), b.debug && console.log("reverse tweensContainer (" + E + "): " + JSON.stringify(I[E]), a)
                                        }
                                    l = I
                                } else if ("start" === A) {
                                    var I;
                                    r(a).tweensContainer && !0 === r(a).isAnimating && (I = r(a).tweensContainer), p.each(g, function(t, e) {
                                        if (RegExp("^" + x.Lists.colors.join("$|^") + "$").test(t)) {
                                            ...
                                            if (x.RegEx.isHex.test(o)) {
                                                for (var s = ["Red", "Green", "Blue"], l = x.Values.hexToRgb(o), c = r ? x.Values.hexToRgb(r) : n, u = 0; u < s.length; u++) {
                                                    var p = [l[u]];
                                                    a && p.push(a), c !== n && p.push(c[u]), g[t + s[u]] = p
                                                }
                                                delete g[t]
                                            }
                                        }
                                    ...
                                    for (var V in g) {
                                        ...
                                        var L = x.Hooks.getRoot(V),
                                            W = !1;
                                        if (r(a).isSVG || "tween" === L || !1 !== x.Names.prefixCheck(L)[1] || x.Normalizations.registered[L] !== n) {
                                            (s.display !== n && null !== s.display && "none" !== s.display || s.visibility !== n && "hidden" !== s.visibility) && /opacity|filter/.test(V) && !H && 0 !== D && (H = 0), s._cacheValues && I && I[V] ? (H === n && (H = I[V].endValue + I[V].unitType), W = r(a).rootPropertyValueCache[L]) : x.Hooks.registered[V] ? H === n ? (W = x.getPropertyValue(a, L), H = x.getPropertyValue(a, V, W)) : W = x.Hooks.templates[L][1] : H === n && (H = x.getPropertyValue(a, V));
                                            var N, F, Q, $ = !1;
                                            if (N = h(V, H), H = N[0], Q = N[1], N = h(V, D), D = N[0].replace(/^([+-\/*])=/, function(t, e) {
                                                    return $ = e, ""
                                                }), F = N[1], H = parseFloat(H) || 0, D = parseFloat(D) || 0, "%" === F && (/^(fontSize|lineHeight)$/.test(V) ? (D /= 100, F = "em") : /^scale/.test(V) ? (D /= 100, F = "") : /(Red|Green|Blue)$/i.test(V) && (D = D / 100 * 255, F = "")), /[\/*]/.test($)) F = Q;
                                            else if (Q !== F && 0 !== H)
                                                if (0 === D) F = Q;
                                                else {
                                                    o = o || function() {
                                                        var t = {
                                                            ...
                                                            n = t.position === q.lastPosition && t.myParent === q.lastParent,
                                                            o = t.fontSize === q.lastFontSize;
                                                        q.lastParent = t.myParent, q.lastPosition = t.position, q.lastFontSize = t.fontSize;
                                                        var s = 100,
                                                            l = {};
                                                        if (o && n) l.emToPx = q.lastEmToPx, l.percentToPxWidth = q.lastPercentToPxWidth, l.percentToPxHeight = q.lastPercentToPxHeight;
                                                        else {
                                                            ...
                                                            }), b.CSS.setPropertyValue(c, "paddingLeft", s + "em"), l.percentToPxWidth = q.lastPercentToPxWidth = (parseFloat(x.getPropertyValue(c, "width", null, !0)) || 1) / s, l.percentToPxHeight = q.lastPercentToPxHeight = (parseFloat(x.getPropertyValue(c, "height", null, !0)) || 1) / s, l.emToPx = q.lastEmToPx = (parseFloat(x.getPropertyValue(c, "paddingLeft")) || 1) / s, t.myParent.removeChild(c)
                                                        }
                                                        return null === q.remToPx && (q.remToPx = parseFloat(x.getPropertyValue(i.body, "fontSize")) || 16), null === q.vwToPx && (q.vwToPx = parseFloat(e.innerWidth) / 100, q.vhToPx = parseFloat(e.innerHeight) / 100), l.remToPx = q.remToPx, l.vwToPx = q.vwToPx, l.vhToPx = q.vhToPx, b.debug >= 1 && console.log("Unit ratios: " + JSON.stringify(l), a), l
                                                    }();
                                ...
                                l.element && (x.Values.addClass(a, "velocity-animating"), _.push(l), "" === s.queue && (r(a).tweensContainer = l, r(a).opts = s), r(a).isAnimating = !0, T === C - 1 ? (b.State.calls.push([_, f, s, null, P.resolver]), !1 === b.State.isTicking && (b.State.isTicking = !0, u())) : T++)
                            }
                            var o, a = this,
                        ...
                        var s, l, h, f, g, y, w = arguments[0] && (arguments[0].p || p.isPlainObject(arguments[0].properties) && !arguments[0].properties.names || v.isString(arguments[0].properties));
                        if (v.isWrapped(this) ? (s = !1, h = 0, f = this, l = this) : (s = !0, h = 1, f = w ? arguments[0].elements || arguments[0].e : arguments[0]), f = a(f)) {
                                    ...
                                    return p.each(b.State.calls, function(t, e) {
                                        e && p.each(e[1], function(i, o) {
                                            ...
                                            return !0 !== a && e[2].queue !== a && (y !== n || !1 !== e[2].queue) || void p.each(f, function(i, n) {
                                                ...
                                                }), p.queue(n, v.isString(y) ? y : "", [])), "stop" === g ? (r(n) && r(n).tweensContainer && !1 !== a && p.each(r(n).tweensContainer, function(t, e) {
                                                    e.endValue = e.currentValue
                                                }), O.push(t)) : "finish" === g && (e[2].duration = 1))
                                            })
                                        })
                                    }), "stop" === g && (p.each(O, function(t, e) {
                                        d(e, !0)
                                    ...
                                    if (!p.isPlainObject(g) || v.isEmptyObject(g)) {
                                        if (v.isString(g) && b.Redirects[g]) {
                                            ...
                                            return !0 === z.backwards && (f = p.extend(!0, [], f).reverse()), p.each(f, function(t, e) {
                                                parseFloat(z.stagger) ? z.delay = M + parseFloat(z.stagger) * t : v.isFunction(z.stagger) && (z.delay = M + z.stagger.call(e, t, C)), z.drag && (z.duration = parseFloat(E) || (/^(callout|transition)/.test(g) ? 1e3 : m), z.duration = Math.max(z.duration * (z.backwards ? 1 - t / C : (t + 1) / C), .75 * z.duration, 200)), b.Redirects[g].call(e, e, z || {}, t, C, f, P.promise ? P : n)
                                            }), t()
                                        }
                            ...
                            var V, z = p.extend({}, b.defaults, y);
                            if (z.loop = parseInt(z.loop), V = 2 * z.loop - 1, z.loop)
                                for (var D = 0; V > D; D++) {
                                    var j = {
                                        delay: z.delay,
                                        progress: z.progress
                                    };
                                    D === V - 1 && (j.display = z.display, j.visibility = z.visibility, j.complete = z.complete), k(f, "reverse", j)
                                }
                            return t()
                        }
                    };
    ...
    function(t, e, i, n) {
        ...
        function S(t) {
            ...
            return new(e || (mt ? L : yt ? F : gt ? $ : H))(t, P)
        }
        ...
        function A(t, e) {
            var i = t.session,
                n = e.pointers,
                o = n.length;
            i.firstInput || (i.firstInput = M(e)), o > 1 && !i.firstMultiple ? i.firstMultiple = M(e) : 1 === o && (i.firstMultiple = !1);
            var a = i.firstInput,
                r = i.firstMultiple,
                s = r ? r.center : a.center,
                l = e.center = I(n);
            e.timeStamp = ht(), e.deltaTime = e.timeStamp - a.timeStamp, e.angle = z(s, l), e.distance = V(s, l), O(i, e), e.offsetDirection = _(e.deltaX, e.deltaY), e.scale = r ? j(r.pointers, n) : 1, e.rotation = r ? D(r.pointers, n) : 0, E(i, e);
            var c = t.element;
        ...
        function O(t, e) {
            var i = e.center,
                ...
                o = t.prevDelta || {},
                a = t.prevInput || {};
            (e.eventType === kt || a.eventType === Tt) && (o = t.prevDelta = {
                x: a.deltaX || 0,
                y: a.deltaY || 0
            }, n = t.offsetDelta = {
                x: i.x,
        ...
        function E(t, e) {
            ...
            if (e.eventType != St && (l > xt || s.velocity === n)) {
                var c = s.deltaX - e.deltaX,
                    u = s.deltaY - e.deltaY,
                    d = q(l, c, u);
                o = d.x, a = d.y, i = pt(d.x) > pt(d.y) ? d.x : d.y, r = _(c, u), t.lastInterval = e
        ...
        function _(t, e) {
            return t === e ? Pt : pt(t) >= pt(e) ? t > 0 ? At : Ot : e > 0 ? Et : Mt
        }
        ...
        function H() {
            this.evEl = jt, this.evWin = Ht, this.allow = !0, this.pressed = !1, T.apply(this, arguments)
        }

        function L() {
            this.evEl = Nt, this.evWin = Ft, T.apply(this, arguments), this.store = this.manager.session.pointerEvents = []
        }

        function W() {
            this.evTarget = $t, this.evWin = Xt, this.started = !1, T.apply(this, arguments)
        }
        ...
        function Q(t, e) {
            var i = b(t.touches),
                n = this.targetIds;
            if (e & (kt | Ct) && 1 === i.length) return n[i[0].identifier] = !0, [i, i];
        ...
        function $() {
            ...
            this.touch = new F(this.manager, t), this.mouse = new H(this.manager, t)
        }
        ...
        function R(t) {
            ...
            var e = g(t, te),
                i = g(t, ee);
            return e && i ? te + " " + ee : e || i ? e ? te : ee : g(t, Jt) ? Jt : Zt
        }

        function Y(t) {
            this.id = k(), this.manager = null, this.options = l(t || {}, this.defaults), this.options.enable = p(this.options.enable, !0), this.state = ie, this.simultaneous = {}, this.requireFail = []
        }
        ...
        function U(t) {
            return t == Mt ? "down" : t == Et ? "up" : t == At ? "left" : t == Ot ? "right" : ""
        }
        ...
        c(H, T, {
            handler: function(t) {
                var e = Dt[t.type];
                e & kt && 0 === t.button && (this.pressed = !0), e & Ct && 1 !== t.which && (e = Tt), this.pressed && this.allow && (e & Tt && (this.pressed = !1), this.callback(this.manager, e, {
                    pointers: [t],
                    changedPointers: [t],
                    pointerType: wt,
                    srcEvent: t
        ...
        t.MSPointerEvent && (Nt = "MSPointerDown", Ft = "MSPointerMove MSPointerUp MSPointerCancel"), c(L, T, {
            handler: function(t) {
                var e = this.store,
                    i = !1,
                    n = t.type.toLowerCase().replace("ms", ""),
                    o = Lt[n],
                    a = Wt[t.pointerType] || t.pointerType,
                    r = a == bt,
                    s = y(e, t.pointerId, "pointerId");
                o & kt && (0 === t.button || r) ? 0 > s && (e.push(t), s = e.length - 1) : o & (Tt | St) && (i = !0), 0 > s || (e[s] = t, this.callback(this.manager, o, {
                    pointers: e,
                    changedPointers: [t],
                    pointerType: a,
                    srcEvent: t
            ...
            preventDefaults: function(t) {
                if (!Ut) {
                    ...
                    var n = this.actions,
                        ...
                        a = g(n, ee),
                        r = g(n, te);
                    return o || a && i & It || r && i & qt ? this.preventSrc(e) : void 0
                }
            },
        ...
        Y.prototype = {
            ...
            getTouchAction: function() {
                var t = this.options.direction,
                    e = [];
                return t & It && e.push(ee), t & qt && e.push(te), e
            },
            directionTest: function(t) {
                var e = this.options,
                    ...
                    a = t.deltaX,
                    r = t.deltaY;
                return o & e.direction || (e.direction & It ? (o = 0 === a ? Pt : 0 > a ? At : Ot, i = a != this.pX, n = Math.abs(t.deltaX)) : (o = 0 === r ? Pt : 0 > r ? Et : Mt, i = r != this.pY, n = Math.abs(t.deltaY))), t.direction = o, i && n > e.threshold && o & e.direction
            },
            attrTest: function(t) {
            ...
            attrTest: function(t) {
                ...
                return i & (It | qt) ? e = t.velocity : i & It ? e = t.velocityX : i & qt && (e = t.velocityY), this._super.attrTest.call(this, t) && i & t.direction && t.distance > this.options.threshold && pt(e) > this.options.velocity && t.eventType & Tt
            },
            emit: function(t) {
                var e = U(t.direction);
...
Vel = jQuery ? jQuery.Velocity : $ ? $.Velocity : Velocity,
    ...
    function(t) {
        t.fn.scrollTo = function(e) {
            ...
            return "open" === e ? (this.each(function() {
                ...
                function o(e) {
                    "focus" === e && (l = !0), n(), c.addClass("active"), r.addClass("active"), !0 === s.constrainWidth ? c.css("width", r.outerWidth()) : c.css("white-space", "nowrap");
                    var i = window.innerHeight,
                        o = r.innerHeight(),
                        u = r.offset().left,
                        d = r.offset().top - t(window).scrollTop(),
                        p = s.alignment,
                        h = 0,
                        f = 0,
                        v = 0;
                    ...
                    var g = 0,
                        m = 0,
                        y = r.parent();
                    if (y.is("body") || (y[0].scrollHeight > y[0].clientHeight && (g = y[0].scrollTop), y[0].scrollWidth > y[0].clientWidth && (m = y[0].scrollLeft)), u + c.innerWidth() > t(window).width() ? p = "right" : u - c.innerWidth() + r.innerWidth() < 0 && (p = "left"), d + c.innerHeight() > i)
                        if (d + o - c.innerHeight() < 0) {
                            var b = i - d - v;
                            c.css("max-height", b)
                        } else v || (v += o), v -= c.innerHeight();
                    "left" === p ? (h = s.gutter, f = r.position().left + h) : "right" === p && (c.stop(!0, !0).css({
                        opacity: 0,
                        left: 0
                    }), f = r.position().left + r.outerWidth() - c.outerWidth() + (h = -s.gutter)), c.css({
                        position: "absolute",
    ...
    function(t) {
            ...
            o = {
                init: function(i) {
                    ...
                    return i = t.extend(o, i), this.each(function() {
                        var o = t(this),
                            a = t(this).attr("id") || "#" + t(this).data("target"),
                            r = function() {
                                var n = o.data("overlay-id"),
                                    a = t("#" + n);
                                o.removeClass("open"), t("body").css({
                                    overflow: "",
                                    width: ""
                                }), o.find(".modal-close").off("click.close"), t(document).off("keyup.modal" + n), a.velocity({
                                    opacity: 0
                                }, {
                                ...
                                var r = {
                                    ...
                                    complete: function() {
                                        t(this).css({
                                            display: "none"
                                        }), "function" == typeof i.complete && i.complete.call(this, o), a.remove(), e--
                                    }
                                };
                            ...
                            s = function(a) {
                                var s = t("body"),
                                    l = s.innerWidth();
                                if (s.css("overflow", "hidden"), s.width(l), !o.hasClass("open")) {
                                    var c = n(),
                                        u = t('<div class="modal-overlay"></div>'),
                                        d = ++e;
                                    u.attr("id", c).css("z-index", 1e3 + 2 * d), o.data("overlay-id", c).css("z-index", 1e3 + 2 * d + 1), o.addClass("open"), t("body").append(u), i.dismissible && (u.click(function() {
                                        r()
                                        ...
                                        queue: !1,
                                        ease: "easeOutCubic"
                                    }), o.data("associated-overlay", u[0]);
                                    var p = {
                                        duration: i.inDuration,
                                        queue: !1,
                                        ease: "easeOutCubic",
                                        complete: function() {
                                            "function" == typeof i.ready && i.ready.call(this, o, a)
                                        }
                                    };
                                    o.hasClass("bottom-sheet") ? o.velocity({
                                        bottom: "0",
                                        opacity: 1
                                    }, p) : (t.Velocity.hook(o, "scaleX", .7), o.css({
                                        top: i.startingTop
                                    }), o.velocity({
                                        top: i.endingTop,
                                        opacity: 1,
                        ...
                        t(document).off("click.modalTrigger", 'a[href="#' + a + '"], [data-target="' + a + '"]'), t(this).off("openModal"), t(this).off("closeModal"), t(document).on("click.modalTrigger", 'a[href="#' + a + '"], [data-target="' + a + '"]', function(e) {
                            i.startingTop = (t(this).offset().top - t(window).scrollTop()) / 1.15, s(t(this)), e.preventDefault()
                ...
                open: function() {
                    o.init.apply(this, arguments), t(this).trigger("openModal")
                },
                close: function() {
        ...
        t.fn.modal = function(e) {
            return o[e] ? o[e].apply(this, Array.prototype.slice.call(arguments, 1)) : "object" != typeof e && e ? void t.error("Method " + e + " does not exist on jQuery.modal") : o.init.apply(this, arguments)
        }
    }(jQuery),
    function(t) {
            ...
            return this.each(function() {
                ...
                if (!t(this).hasClass("initialized")) {
                    ...
                    s.wrap(l), s.on("click", function() {
                        ...
                        var g = 0,
                            m = 0;
                        u / l > d / c ? (g = .9 * l, m = .9 * l * (d / u)) : (g = .9 * c * (u / d), m = .9 * c), s.hasClass("responsive-img") ? s.velocity({
                            "max-width": g,
                            width: u
                        }, {
                            duration: 0,
                            ...
                            complete: function() {
                                s.css({
                                    ...
                                    height: m,
                                    width: g,
                                    left: t(document).scrollLeft() + l / 2 - s.parent(".material-placeholder").offset().left - g / 2,
                                    top: t(document).scrollTop() + c / 2 - s.parent(".material-placeholder").offset().top - m / 2
                                }, {
                                    duration: 275,
                                    queue: !1,
                                    easing: "easeOutQuad",
            ...
            init: function(e) {
                ...
                return this.each(function(i) {
                    var o, a, r, s, l, c = n + i,
                        ...
                        m = !1,
                        y = function(t) {
                            return Math.ceil(h - t.position().left - t.outerWidth() - u.scrollLeft())
                        },
                        b = function(t) {
                    ...
                    e.swipeable && d > e.responsiveThreshold && (e.swipeable = !1), 0 === (o = t(p.filter('[href="' + location.hash + '"]'))).length && (o = t(this).find("li.tab a.active").first()), 0 === o.length && (o = t(this).find("li.tab a").first()), o.addClass("active"), (g = p.index(o)) < 0 && (g = 0), void 0 !== o[0] && (a = t(o[0].hash)).addClass("active"), u.find(".indicator").length || u.append('<li class="indicator"></li>'), s = u.find(".indicator"), u.append(s), u.is(":visible") && setTimeout(function() {
                        ...
                        h = u.width(), v = Math.max(h, u[0].scrollWidth) / p.length, g < 0 && (g = 0), 0 !== v && 0 !== h && (s.css({
                            right: y(o)
                        }), s.css({
                            left: b(o)
                        }))
                        ...
                        onCycleTo: function(t) {
                            if (!m) {
                                var i = g;
                                g = r.index(t), o = p.eq(g), w(i), "function" == typeof e.onShow && e.onShow.call(u[0], a)
                            }
                        }
                        ...
                        if (t(this).parent().hasClass("disabled")) i.preventDefault();
                            ...
                            m = !0, h = u.width(), v = Math.max(h, u[0].scrollWidth) / p.length, o.removeClass("active");
                            var n = a;
                            o = t(this), a = t(Materialize.escapeHash(this.hash)), p = u.find("li.tab a");
                            o.position();
                            o.addClass("active"), prev_index = g, (g = p.index(t(this))) < 0 && (g = 0), e.swipeable ? f.length && f.carousel("set", g, function() {
                    ...
                    "mouseenter.tooltip": function(t) {
                        p = setTimeout(function() {
                            ...
                            "top" === s ? (t = o.offset().top - l - 5, i = o.offset().left + a / 2 - p / 2, n = e(i, t, p, l), f = "-10px", u.css({
                                ...
                                top: n.y,
                                left: n.x
                            }), y = Math.SQRT2 * p / parseInt(g), b = Math.SQRT2 * l / parseInt(m), w = Math.max(y, b), c.velocity({
                                translateY: f,
                                translateX: v
                            }, {
                                duration: 350,
    ...
    function(t) {
        ...
        var a = function(t) {
            ...
            if (e.classList.add("toast"), i)
                for (var o = i.split(" "), a = 0, r = o.length; a < r; a++) e.classList.add(o[a]);
        ...
        t && o.appendChild(a), a.style.opacity = 0, Vel(a, {
            translateY: "-35px",
            opacity: 1
        }, {
            duration: 300,
        ...
        null != s && (r = setInterval(function() {
            null === a.parentNode && window.clearInterval(r), a.classList.contains("panning") || (s -= 20), s <= 0 && (Vel(a, {
                opacity: 0,
                marginTop: "-40px"
            }, {
                duration: 375,
        ...
        t(document).ready(function() {
            function e(e) {
                var i = e.css("font-family"),
                    o = e.css("font-size"),
                    a = e.css("line-height");
                o && n.css("font-size", o), i && n.css("font-family", i), a && n.css("line-height", a), e.data("original-height") || e.data("original-height", e.height()), "off" === e.attr("wrap") && n.css("overflow-wrap", "normal").css("white-space", "pre"), n.text(e.val() + "\n");
                var r = n.html().replace(/\n/g, "<br>");
                n.html(r), e.is(":visible") ? n.css("width", e.width()) : n.css("width", t(window).width() / 2), e.data("original-height") <= n.height() ? e.css("height", n.height()) : e.val().length < e.data("previous-length") && e.css("height", e.data("original-height")), e.data("previous-length", e.val().length)
            }
                        ...
                        n.off("blur.autocomplete").on("blur.autocomplete", function() {
                            ...
                            if (13 !== r.which && 38 !== r.which && 40 !== r.which) {
                                if (i !== s && (p(), s.length >= e.minLength))
                                    for (var l in o)
                                        if (o.hasOwnProperty(l) && -1 !== l.toLowerCase().indexOf(s) && l.toLowerCase() !== s) {
                                            if (a >= e.limit) break;
                                            var d = t("<li></li>");
            ...
            t(this).each(function() {
                ...
                if (!n.hasClass("browser-default")) {
                    ...
                    if (a && (n.parent().find("span.caret").remove(), n.parent().find("input").remove(), n.unwrap(), t("ul#select-options-" + a).remove()), "destroy" !== e) {
                            ...
                            t(this).click(function(r) {
                                if (!t(this).hasClass("disabled") && !t(this).hasClass("optgroup")) {
                                    ...
                                    o ? (t('input[type="checkbox"]', this).prop("checked", function(t, e) {
                                        return !e
                                    }), s = i(u, a, n), g.trigger("focus")) : (l.find("li").removeClass("active"), t(this).toggleClass("active"), g.val(t(this).text())), m(l, t(this)), n.find("option").eq(a).prop("selected", s), n.trigger("change"), void 0 !== e && e()
                                }
                                r.stopPropagation()
                            })
                        }), n.wrap(s);
                        ...
                        n.before(g), g.before(f), g.after(l), n.is(":disabled") || g.dropdown({
                            hover: !1
                            ...
                            if (9 != e.which)
                                if (40 != e.which || l.is(":visible")) {
                                    if (13 != e.which || l.is(":visible")) {
                                        ...
                                        40 == e.which && (r = l.find("li.selected").length ? l.find("li.selected").next("li:not(.disabled)")[0] : l.find("li:not(.disabled)")[0], m(l, r)), 27 == e.which && g.trigger("close"), 38 == e.which && (r = l.find("li.selected").prev("li:not(.disabled)")[0]) && m(l, r), setTimeout(function() {
                                            y = []
                                        }, 1e3)
                                    }
                                } else g.trigger("open");
    ...
    function(t) {
        ...
        function e(a, s, u, d) {
            ...
            function h() {
                k.data(s, T).addClass(x.input).attr("tabindex", -1).val(k.data("value") ? T.get("select", w.format) : a.value), w.editable || k.on("focus." + b.id + " click." + b.id, function(t) {
                    t.preventDefault(), T.$root.eq(0).focus()
                }).on("keydown." + b.id, g), o(a, {
                    haspopup: !0,
                    expanded: !1,
                    readonly: !1,
                    owns: a.id + "_root"
            ...
            function v() {
                var e;
                !0 === w.hiddenName ? (e = a.name, a.name = "") : e = (e = ["string" == typeof w.hiddenPrefix ? w.hiddenPrefix : "", "string" == typeof w.hiddenSuffix ? w.hiddenSuffix : "_submit"])[0] + a.name + e[1], T._hidden = t('<input type=hidden name="' + e + '"' + (k.data("value") || a.value ? ' value="' + T.get("select", w.formatSubmit) + '"' : "") + ">")[0], k.on("change." + b.id, function() {
                    T._hidden.value = a.value ? T.get("select", w.formatSubmit) : ""
                }), w.container ? t(w.container).append(T._hidden) : k.after(T._hidden)
            }
            ...
            var y = !1,
                ...
                T = C.prototype = {
                    ...
                    $node: k,
                    start: function() {
                        return b && b.start ? T : (b.methods = {}, b.start = !0, b.open = !1, b.type = a.type, a.autofocus = a == r(), a.readOnly = !w.editable, a.id = a.id || b.id, "text" != a.type && (a.type = "text"), T.component = new u(T, w), T.$root = t(e._.node("div", p(), x.picker, 'id="' + a.id + '_root" tabindex="0"')), f(), w.formatSubmit && v(), h(), w.container ? t(w.container).append(T.$root) : k.after(T.$root), T.on({
                    ...
                    stop: function() {
                        return b.start ? (T.close(), T._hidden && T._hidden.parentNode.removeChild(T._hidden), T.$root.remove(), k.removeClass(x.input).removeData(s), setTimeout(function() {
                            k.off("." + b.id)
                        }, 0), a.type = b.type, a.readOnly = !1, T.trigger("stop"), b.methods = {}, b.start = !1, T) : T
                    },
                    open: function(i) {
                        return b.open ? T : (k.addClass(x.active), o(a, "expanded", !0), setTimeout(function() {
                            ...
                            var n = i.keyCode,
                                o = T.component.key[n],
                                a = i.target;
                            27 == n ? T.close(!0) : a != T.$root[0] || !o && 13 != n ? t.contains(T.$root[0], a) && 13 == n && (i.preventDefault(), a.click()) : (i.preventDefault(), o ? e._.trigger(T.component.key.go, T, [e._.trigger(o)]) : T.$root.find("." + x.highlighted).hasClass(x.disabled) || T.set("select", T.component.item.highlight).close())
                        })), T.trigger("open"))
                    },
                    close: function(t) {
                        return t && (T.$root.off("focus.toOpen").eq(0).focus(), setTimeout(function() {
                            T.$root.on("focus.toOpen", m)
                        }, 0)), k.removeClass(x.active), o(a, "expanded", !1), setTimeout(function() {
                    ...
                    set: function(e, i, n) {
                        ...
                        if (n = r && t.isPlainObject(i) ? i : n || {}, e) {
                            r || (s[e] = i);
                            for (o in s) a = s[o], o in T.component.item && (void 0 === a && (a = null), T.component.set(o, a, n)), "select" != o && "clear" != o || k.val("clear" == o ? "" : T.get(o, w.format)).trigger("change");
                            T.render()
                        }
    ...
    function() {
        ...
        function n(n, r) {
            function l(t, e) {
                ...
                if (!e || !(u < y - w || u > y + w)) {
                    ...
                    E.setHand(l, c, !e, !0), s.off(h).on(h, function(t) {
                        ...
                        (e || p) && n === l && u === c && E.setHand(n, u), "hours" === E.currentView ? E.toggleView("minutes", k / 2) : r.autoclose && (E.minutesView.addClass("clockpicker-dial-out"), setTimeout(function() {
                            E.done()
                        }, k / 2)), d.prepend(z), clearTimeout(v), E.popover.removeClass("clockpicker-moving"), s.off(h)
                    })
                }
            }
            var u = a(C),
                ...
                E = this;
            this.id = i("cp"), this.element = n, this.holder = v, this.options = r, this.isAppended = !1, this.isShown = !1, this.currentView = "hours", this.isInput = P, this.input = A, this.label = O, this.popover = u, this.plate = d, this.hoursView = g, this.minutesView = T, this.amPmBlock = S, this.spanHours = u.find(".clockpicker-span-hours"), this.spanMinutes = u.find(".clockpicker-span-minutes"), this.spanAmPm = u.find(".clockpicker-span-am-pm"), this.footer = u.find(".picker__footer"), this.amOrPm = "PM", r.twelvehour && (r.ampmclickable ? (this.spanAmPm.empty(), a('<div id="click-am">AM</div>').on("click", function() {
            ...
            var M, I, q, _, V = a('<div class="clockpicker-tick"></div>');
            if (r.twelvehour)
                for (M = 1; M < 13; M += 1) I = V.clone(), q = M / 6 * Math.PI, _ = y, I.css({
                    left: m + Math.sin(q) * _ - w,
                    top: m - Math.cos(q) * _ - w
                }), I.html(0 === M ? "00" : M), g.append(I), I.on(p, l);
            else
                for (M = 0; M < 24; M += 1) I = V.clone(), q = M / 6 * Math.PI, _ = M > 0 && M < 13 ? b : y, I.css({
                    left: m + Math.sin(q) * _ - w,
                    top: m - Math.cos(q) * _ - w
                }), I.html(0 === M ? "00" : M), g.append(I), I.on(p, l);
            for (M = 0; M < 60; M += 5) I = V.clone(), q = M / 30 * Math.PI, I.css({
                left: m + Math.sin(q) * y - w,
                top: m - Math.cos(q) * y - w
            }), I.html(e(M)), T.append(I), I.on(p, l);
            if (d.on(p, function(t) {
                    0 === a(t.target).closest(".clockpicker-tick").length && l(t, !0)
                }), c) {
                var z = u.find(".clockpicker-canvas"),
                    D = t("svg");
                D.setAttribute("class", "clockpicker-svg"), D.setAttribute("width", x), D.setAttribute("height", x);
                var j = t("g");
                j.setAttribute("transform", "translate(" + m + "," + m + ")");
                var H = t("circle");
                ...
                var W = t("circle");
                W.setAttribute("class", "clockpicker-canvas-bg"), W.setAttribute("r", w), j.appendChild(L), j.appendChild(W), j.appendChild(H), D.appendChild(j), z.append(D), this.hand = L, this.bg = W, this.bearing = H, this.g = j, this.canvas = z
            }
            o(this.options.init)
        }
        ...
        n.DEFAULTS = {
            ...
            if (p.twelvehour && (f = y), s < 0 && (s = 2 * Math.PI + s), r = Math.round(s / u), s = r * u, p.twelvehour ? l ? 0 === r && (r = 12) : (n && (r *= 5), 60 === r && (r = 0)) : l ? (12 === r && (r = 0), r = h ? 0 === r ? 12 : r : 0 === r ? 0 : r + 12) : (n && (r *= 5), 60 === r && (r = 0)), this[this.currentView] !== r && v && this.options.vibrate && (this.vibrateTimer || (navigator[v](10), this.vibrateTimer = setTimeout(a.proxy(function() {
                ...
                var g = Math.sin(s) * (f - w),
                    m = -Math.cos(s) * (f - w),
                    x = Math.sin(s) * f,
                    k = -Math.cos(s) * f;
                this.hand.setAttribute("x2", g), this.hand.setAttribute("y2", m), this.bg.setAttribute("cx", x), this.bg.setAttribute("cy", k)
        ...
        var e = {
            init: function(e) {
                ...
                return this.each(function(i) {
                    ...
                    function l() {
                        var t, e, i;
                        e = (t = Date.now()) - q, q = t, i = b - I, I = b, O = .8 * (1e3 * i / (1 + e)) + .2 * O
                    }

                    function c() {
                        var t, i;
                        P && (t = Date.now() - q, (i = P * Math.exp(-t / e.duration)) > 2 || i < -2 ? (s(A - i), requestAnimationFrame(c)) : s(A))
                    }
                    ...
                    function d(t) {
                        var i = w % C - t;
                        e.noWrap || (i < 0 ? Math.abs(i + C) < Math.abs(i) && (i += C) : i > 0 && Math.abs(i - C) < i && (i -= C)), i < 0 ? W.trigger("carouselNext", [Math.abs(i)]) : i > 0 && W.trigger("carouselPrev", [i])
                    }

                    function p(t) {
                        "mousedown" === t.type && t.preventDefault(), x = !0, V = !1, z = !1, T = o(t), S = a(t), O = P = 0, I = b, q = Date.now(), clearInterval(_), _ = setInterval(l, 100)
                    }

                    function h(t) {
                        var e, i;
                        if (x)
                            if (e = o(t), y = a(t), i = T - e, Math.abs(S - y) < 30 && !z)(i > 2 || i < -2) && (V = !0, T = e, s(b + i));
                            else {
                    ...
                    function f(t) {
                        if (x) return x = !1, clearInterval(_), A = b, (O > 10 || O < -10) && (A = b + (P = .9 * O)), A = Math.round(A / k) * k, e.noWrap && (A >= k * (C - 1) ? A = k * (C - 1) : A < 0 && (A = 0)), P = A - b, q = Date.now(), requestAnimationFrame(c), V && (t.preventDefault(), t.stopPropagation()), !1
                    }
                    var v, g, m, b, w, x, k, C, T, S, P, A, O, E, M, I, q, _, V, z, D = n + i,
                        j = t('<ul class="indicators"></ul>'),
                        H = null,
                        L = null,
                        W = t(this),
                        N = W.attr("data-indicators") || e.indicators;
                    if (e.fullWidth && (e.dist = 0, function() {
                            var e = W.find(".carousel-item img").first();
                            if (e.length) e.prop("complete") ? W.css("height", e.height()) : e.on("load", function() {
                                W.css("height", t(this).height())
                            });
                            else {
                                var i = W.find(".carousel-item").first().height();
                                W.css("height", i)
                            }
                        }(), N && W.find(".carousel-fixed-item").addClass("with-indicators")), W.hasClass("initialized")) return t(window).trigger("resize"), t(this).trigger("carouselNext", [1e-6]), !0;
                    W.addClass("initialized"), x = !1, b = A = 0, v = [], g = W.find(".carousel-item").first().innerWidth(), m = W.find(".carousel-item").first().innerHeight(), k = 2 * g + e.padding, W.find(".carousel-item").each(function(e) {
                    ...
                    }), N && W.append(j), C = v.length, M = "transform", ["webkit", "Moz", "O", "ms"].every(function(t) {
                        var e = t + "Transform";
                        return void 0 === document.body.style[e] || (M = e, !1)
                    }), t(window).off("resize.carousel-" + D).on("resize.carousel-" + D, function() {
                        e.fullWidth ? (g = W.find(".carousel-item").first().innerWidth(), m = W.find(".carousel-item").first().innerHeight(), k = 2 * g + e.padding, A = b = 2 * w * g) : s()
                    }), void 0 !== window.ontouchstart && (W[0].addEventListener("touchstart", p), W[0].addEventListener("touchmove", h), W[0].addEventListener("touchend", f)), W[0].addEventListener("mousedown", p), W[0].addEventListener("mousemove", h), W[0].addEventListener("mouseup", f), W[0].addEventListener("mouseleave", f), W[0].addEventListener("click", u), s(b), t(this).on("carouselNext", function(t, e, i) {
                        void 0 === e && (e = 1), "function" == typeof i && (L = i), A = k * Math.round(b / k) + k * e, b !== A && (P = A - b, q = Date.now(), requestAnimationFrame(c))
                    ...
                    var l = function() {
                        ...
                        c = function() {
                            ...
                            var c = i.outerWidth(),
                                ...
                                D = k / 2 - _ / 2,
                                j = {};
                            j.top = b ? T : "", j.right = y ? h - S - k : "", j.bottom = w ? f - T - C : "", j.left = m ? S : "", j.position = P, o.css(j), s.css({
                                width: A,
                                height: O,
                                top: E,
                                right: 0,
