		...
		<div class="col l2 m3 s4">
			...
			<ul class="collection sticky">
				<li class="collection-item center">
					...
					<a id="offer-property-btn" href="messages.php" class="center collection-item collection-active waves-effect waves-light">Messages</a>
			</ul>
		...
		<div class="col l8 m6 s8">
			<div class="row card">
				<div class="card-content">
					...
					<p>Read and reply to messages you received.</p>
